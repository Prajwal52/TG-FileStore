...
│
├🔸👨‍💻 **Developer:** [Sai](https://t.me/Sai_Moviezz) 
│
├🔹👥 **Main Channel:** [Join](https://t.me/Sai_Moviezz)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
...
⚠️ Benefits: If you have a TeleGram Movie Channel or Any Copyright Channel, Then Its Useful for Daily Usage, You can Send Me Your File & I will Send Permanent Link to You & Channel will be Safe from **CopyRight Infringement** Issue. My Main Channel Also You Can Check **About Bot**.
